...
from iris.utils.load_deformed import load_deformed_tetrahedrons
        ...
        for split in self.split.split("+"):
            ...
            with Progress(
                ...
                for camera_idx, (camera_from_dataloader, batch) in enumerate(progress.track(dataloader, total=len(dataset))):
                    ...
                    # setup sampler
                    pipeline.model.sampler.update_geometry(
                        means=pipeline.model.field.mlp_base.encoder.gauss_params["means"].detach(),
                        log_covs=pipeline.model.field.mlp_base.encoder.gauss_params["log_covs"].detach(),
                        rots=pipeline.model.field.mlp_base.encoder.quats.detach(),
                    )
