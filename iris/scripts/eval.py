...
class ComputePSNR:
    ...
    # no of rays per chunk
    eval_num_rays_per_chunk: int = 65536

    def main(self) -> None:
        """Main function."""
        print("******************")
        print(f"{self.eval_num_rays_per_chunk}")
        print("******************")
        config, pipeline, checkpoint_path, _ = eval_setup(self.load_config, eval_num_rays_per_chunk=self.eval_num_rays_per_chunk)
